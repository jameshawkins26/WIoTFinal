...
#define FLASH_URL_ADDRESS_ID 5 /**< Address of URL message in FLASH */
// #define FLASH_URL_ADDRESS_ID_2 6

//https://www.cs.virginia.edu/~jrh4az/wiotfinal.html
...
//static const uint8_t m_url_2[] = {'a', 'n', 'o', 't', 'h', 'e', 'r', '.', 'c', 'o', 'm'};
